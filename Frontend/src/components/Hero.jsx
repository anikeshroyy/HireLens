...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[85vh] bg-slate-50 dark:bg-slate-950 overflow-hidden px-4 sm:px-6 py-12 lg:py-20 flex items-center justify-center">
